...
|-----------|-------------|----------|
| **M0: Skeleton** | Project structure, dependencies, MCP server stub | 0.5 day |
| **M1: Auth Flow** | Browser profile management, init command, health_check | 1 day |
| **M2: Read Operations** | list_notebooks, get_notebook, list_sources | 1 day |
| **M3: Write Operations** | add_source (URL + text) | 1 day |
| **M4: Query** | ask tool with citation extraction | 1 day |
| **M5: Polish** | Error handling, retry logic, rate limiting | 0.5 day |
| **M6: Docs & Testing** | README, manual test, basic unit tests | 0.5 day |

**Total MVP Estimate: 5.5 half-days (~3 days)**
